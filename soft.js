(function () {
    ...
    var outerHTML = soft.internalHelpers.outerHTML = function (open, tagname, parent) {
        if (~open.indexOf(softVoid)) {
            return open;
        }

        var close = '</' + tagname + '>';
        return open + innerHTML(open, tagname, parent) + close;
    };
    
    var stripAttributes = soft.internalHelpers.stripAttributes = function (tag, attr) {
